...
{
    /// <inheritdoc />
    public partial class IdentityRbacDiemNamHoc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiemThanhPhans_DiemSos_MaDiem",
                        column: x => x.MaDiem,
                        principalTable: "DiemSos",
            ...
            migrationBuilder.Sql(
                """
                INSERT INTO DiemThanhPhans (MaDiem, Loai, Diem, ThuTu)
                SELECT MaDiem, CAST(1 AS tinyint), DiemMieng, 0 FROM DiemSos WHERE DiemMieng IS NOT NULL;
                INSERT INTO DiemThanhPhans (MaDiem, Loai, Diem, ThuTu)
                SELECT MaDiem, CAST(2 AS tinyint), Diem15p, 0 FROM DiemSos WHERE Diem15p IS NOT NULL;
                """);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KyHocs", x => new { x.NamHoc, x.HocKy });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentStudentLinks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParentStudentLinks_HocSinhs_MaHS",
                        column: x => x.MaHS,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiemSos_MaHS_MaMon_NamHoc_HocKy",
                table: "DiemSos",
                columns: new[] { "MaHS", "MaMon", "NamHoc", "HocKy" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiemThanhPhans_MaDiem",
                table: "DiemThanhPhans",
                column: "MaDiem");

            migrationBuilder.CreateIndex(
                name: "IX_ParentStudentLinks_MaHS",
                table: "ParentStudentLinks",
                column: "MaHS");

            migrationBuilder.CreateIndex(
                name: "IX_ParentStudentLinks_UserId_MaHS",
                table: "ParentStudentLinks",
                columns: new[] { "UserId", "MaHS" },
                unique: true);
